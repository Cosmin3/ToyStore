    ...
    public partial class EmployeeOrderNegociate : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            foreach(ListItem product in ListBox1.Items)
            {
               ...
               if( web.acceptOrderDetails(web.GetProductsCode2(product.Text), Convert.ToInt32(arrayList[1]) - Convert.ToInt32(arrayList[3]))&&( web.acceptOrder(Convert.ToString(Session["Order"])))&&web.OrderPayment(web.TotalOrderCost(Convert.ToInt32(Session["Order"])),web.getCustomerbyorder(Convert.ToInt32(Session["Order"]))))
               {
